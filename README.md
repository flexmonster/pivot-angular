...
This sample project uses [Flexmonster Angular wrapper](https://github.com/flexmonster/ngx-flexmonster?=gh_ng), which is released as an MIT-licensed (free and open-source) add-on to Flexmonster Pivot.
